...
- Itens concluidos nesta rodada:
  ...
  - pre-carregamento da pre-visualizacao fiscal a partir do agendamento selecionado (sessionStorage)
...
- [x] Executar smoke dos fluxos criticos.
...
- [x] Criar roteiro de execucao de homologacao por ordem de RF (`docs/ROTEIRO_HOMOLOGACAO_DIA.md`).
