        ...
        <CardContent className="space-y-3">
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
            <div className="space-y-1">
              ...
              <Select value={modoImportacao} onValueChange={(value) => setModoImportacao(value as ServiceImportMode)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-1">
              ...
              <Select value={formatoModelo} onValueChange={(value) => setFormatoModelo(value as ServiceImportTemplateFormat)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
