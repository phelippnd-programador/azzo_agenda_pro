        ...
        <CardHeader>
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-muted-foreground">
              Envie a planilha, escolha o modo de tratamento e valide o resultado pelo historico de jobs.
            </p>
          </div>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
            <div className="space-y-1">
              ...
              <Select value={modoImportacao} onValueChange={(value) => setModoImportacao(value as ClientImportMode)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  {IMPORT_MODE_OPTIONS.map((option) => (
                    <SelectItem key={option} value={option}>{IMPORT_MODE_LABELS[option]}</SelectItem>
                  ))}
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-1">
              ...
              <Select value={formatoModelo} onValueChange={(value) => setFormatoModelo(value as ClientImportTemplateFormat)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
