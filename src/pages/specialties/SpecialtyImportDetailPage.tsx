          ...
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
            <div className="rounded-xl border border-border/60 bg-muted/20 px-4 py-3">
              ...
              <p className="text-xs text-muted-foreground">
                {job.linhasProcessadas}/{job.linhasRecebidas} linhas
              </p>
            </div>
            <div className="rounded-xl border border-border/60 bg-muted/20 px-4 py-3">
              ...
              <p className="text-xs text-muted-foreground">Linhas processadas sem erro</p>
            </div>
            <div className="rounded-xl border border-border/60 bg-muted/20 px-4 py-3">
              ...
              <p className="text-xs text-muted-foreground">Linhas com falha de validacao</p>
            </div>
          </div>
