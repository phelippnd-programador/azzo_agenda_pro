...
export function CrudListToolbar({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-border/70 bg-card/75 p-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:p-4">
      <div className={`relative w-full flex-1 ${searchMaxWidthClassName}`}>
        ...
        <Input
          ...
          className="border-border/70 bg-background/85 pl-9"
        />
      </div>
